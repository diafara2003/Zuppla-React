...
import { useTablePerfil } from '../Hook/useTablePerfil';
import { PerfilOption } from '../../PerfilesOption/Views/PerfilOption';
...
export const TablePerfiles = ({ dataTable, onClick }: props) => {
    ...
    const { clickAction, clickEstado, eventClick, handleClick } = useTablePerfil({ onClick });
    return (
        <>
            <TableContainer>
            ...
            {eventClick == null ? null : <PerfilOption event={eventClick} opSelected={clickAction} />}
        </>
    )
}
